...
namespace CodeFirstApporach.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        // GET: api/Products
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Product>>> GetGetProducts()
        {
        ...
        {
            var product = await _context.GetProducts.FindAsync(id);
        ...
        public async Task<IActionResult> DeleteProduct(int id)
        {
            ...
            _context.GetProducts.Remove(product);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.GetProducts.Any(e => e.Pid == id);
        }
    }
}
